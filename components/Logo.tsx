    ...
    >
      ...
      >
        <defs>
          ...
          <linearGradient id="orbit-gradient" x1="0%" y1="100%" x2="100%" y2="0%">
        ...
        <rect x="61.5" y="26.5" width="4.5" height="4.5" fill="url(#pixel-gradient)" className="opacity-90" />
        <rect x="68" y="26.5" width="3.5" height="3.5" fill="url(#pixel-gradient)" className="opacity-80" />
        <rect x="67" y="21.5" width="3" height="3" fill="url(#pixel-gradient)" className="opacity-90" />
        <rect x="71" y="21.5" width="3.5" height="3.5" fill="url(#pixel-gradient)" className="opacity-95" />
        <rect x="69.5" y="15" width="4" height="4" fill="url(#pixel-gradient)" className="opacity-90" />
        <rect x="72.5" y="10.5" width="2.5" height="2.5" fill="url(#pixel-gradient)" className="opacity-70" />
      </svg>
    </div>
  );
};
